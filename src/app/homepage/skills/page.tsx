...
const skills = () => {
    return (
        <div className="relative max-[900px]:mt-[50px] flex flex-col w-[800px] h-auto mt-[109px] justify-center max-[900px]:w-full">
            <MotionSection
                initX={40}
                initY={0}
            ...
            <div className="w-full h-auto mt-[28px] grid grid-rows-2 max-[870px]:gap-[5px] gap-[21px]">
                <div
                    className="transition-transform duration-300 h-auto grid min-[870px]:grid-cols-2 max-[870px]:gap-[5px] max-[870px]:grid-rows-2 max-[870px]:justify-items-center gap-[21px]">
                    <MotionSection
                        initX={-40}
                        initY={0}
                        className="relative max-[500px]:w-full w-[390px] h-[200px]">
                        <SkillsButton
                ...
                <div
                    className="w-full transition-transform duration-300 h-auto grid min-[870px]:grid-cols-2 max-[870px]:gap-[5px] max-[870px]:grid-rows-2 max-[870px]:justify-items-center gap-[21px]">
                    <MotionSection
                        initX={40}
                        initY={0}
                        className="relative max-[500px]:w-full w-[390px] h-[200px]">
